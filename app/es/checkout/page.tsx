...
function CheckoutForm() {
  ...
  const getPhonePrefix = (countryValue: string): string => {
    ...
    return phonePrefixMap[countryValue] || "+34"
  }
  ...
  const formatPhoneNumber = (value: string, countryValue: string): string => {
    ...
    switch (countryValue) {
      ...
      case "FR":
      case "DE":
        // EU (except IT): 9 digits, format XXX XXX XXX
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (!cardNumberElement) {
      setErrorMessage("La informacion de la tarjeta esta incompleta")
      setIsLoading(false)
      return
    }
    ...
    if (error) {
      setErrorMessage(error.message || "Se ha producido un error inesperado.")
      setIsLoading(false)
      return
    }
    ...
    <>
      {items.length === 0 && (
        <div className="text-center py-8">
          ...
          <p className="text-sm text-muted-foreground mb-4">Añade algunos artículos para empezar</p>
          <Link href="/es" className="text-sm font-medium underline text-[#2d5f4f]">
            Volver a la tienda
          </Link>
        </div>
      )}
      ...
      {items.length > 0 && (
        <div className="bg-black text-white text-center py-3 rounded-lg mb-6">
          <p className="text-sm font-medium">Carrito reservado durante {formatTime(timeLeft)}</p>
          <p className="text-xs text-gray-300 mt-1">{"🌱 Haz tu pedido ahora y tu hibisco florecera en los primeros dias de primavera."}</p>
        </div>
      )}
        ...
        {items.map((item) => (
          <div key={item.id} className="flex gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-sm font-medium leading-tight mb-1">Kit Flores de Hibisco Raras | Multicolor</h3>
      ...
      <div className="flex gap-2 mb-6">
        <Input type="text" placeholder="Codigo de descuento" className="h-12" />
      ...
      <div className="space-y-3 border-t border-border pt-4">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className="font-medium">
            {hasCompleteAddress ? `€${shippingCost.toFixed(2)}` : "Introduce direccion de envio"}
          </span>
        </div>
  ...
  return (
    <>
      <Script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDqvHKN8KCXLdBQISQPUUg2aDFuJ0AdYsg&libraries=places&language=es"
        ...
        <div className="container mx-auto px-4 py-6 lg:py-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            <div className="order-2 lg:order-1">
              ...
              {paymentRequest && (
                <div className="mb-8">
                  <p className="text-center text-sm text-muted-foreground mb-4">Pago rapido</p>
              ...
              <div className="mb-6">
                ...
                <Input
                  type="email"
                  placeholder="Email o numero de telefono movil"
                  className="h-12"
                  value={email}
                ...
                <div className="flex items-start gap-2 mt-3">
                  ...
                  <label htmlFor="tracking" className="text-sm leading-tight cursor-pointer">
                    Enviame seguimiento en tiempo real y actualizaciones del pedido
                  </label>
                </div>
              </div>
              ...
              {/* Delivery */}
              <div className="mb-6">
                <h2 className="text-base font-semibold mb-4">Entrega</h2>

                <div className="space-y-4">
                  <div>
                    <Label className="text-xs text-muted-foreground mb-1.5 block">{"Pais/Region"}</Label>
                  ...
                  <div>
                    <Input type="text" placeholder="Apartamento, piso, etc. (opcional)" className="h-12" />
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <label htmlFor="news" className="text-sm leading-tight cursor-pointer">
                      Enviame noticias y ofertas por SMS
                    </label>
                  </div>
                </div>
              </div>
              ...
              {/* Shipping method */}
              <div className="mb-6">
                <h2 className="text-base font-semibold mb-4">Metodo de envio</h2>
                {!hasCompleteAddress ? (
                  <div className="bg-[#F8F8F8] border border-border rounded-lg p-4">
                    <p className="text-sm text-[#8B6914]">
                      Introduce tu direccion de envio para ver los metodos de envio disponibles.
                    </p>
                  </div>
                ) : (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <Label htmlFor="standard" className="cursor-pointer">
                            <div className="font-normal">Estandar</div>
                            <div className="text-xs text-muted-foreground mt-0.5">{"7-10 dias"}</div>
                          </Label>
                        </div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <Label htmlFor="express" className="cursor-pointer">
                            ...
                            <div className="text-xs text-muted-foreground mt-0.5">{"3-4 dias"}</div>
                          </Label>
                        </div>
              ...
              {/* Secure Checkout */}
              <div className="mb-6">
                <h2 className="text-xl font-semibold mb-2">Pago Seguro</h2>
                <p className="text-sm text-muted-foreground mb-4">
                  Todas las transacciones son seguras y estan encriptadas. Tu pedido esta protegido por nuestra garantia de satisfaccion de 30 dias.
                </p>

                <div className="border border-border rounded-lg overflow-hidden">
                  <div className="flex items-center justify-between px-4 py-3.5 bg-[#F3F8F4] border border-[#014B22] rounded-t-lg">
                    <span className="font-medium text-sm">Tarjeta de credito</span>
                  ...
                  <div className="bg-[#F8F8F8] p-4 space-y-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <label htmlFor="billing" className="text-sm leading-tight cursor-pointer">
                        Usar direccion de envio como direccion de facturacion
                      </label>
                    </div>
                  </div>
                </div>
              ...
              {hasCompleteAddress && !useShippingAsBilling && (
                <div className="mb-6">
                  <h2 className="text-base font-semibold mb-4">Direccion de facturacion</h2>
                    ...
                    <div className="flex items-center justify-between border border-[#016630] rounded-lg p-4 bg-[#f0f8f0]">
                      <div className="flex items-center gap-3">
                        ...
                        <Label htmlFor="same" className="cursor-pointer font-normal">
                          Igual que la direccion de envio
                        </Label>
                      </div>
                    </div>
                    <div className="flex items-center justify-between border border-border rounded-lg p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <Label htmlFor="different" className="cursor-pointer font-normal">
                          Usar una direccion de facturacion diferente
                        </Label>
                      </div>
                    </div>
                  </RadioGroup>
              ...
              <div className="mb-6">
                <h2 className="text-base font-semibold mb-4">Recuerdame</h2>
                <div className="flex items-start gap-2 mb-4">
                  ...
                  <label htmlFor="remember" className="text-sm leading-tight cursor-pointer">
                    Guardar mi informacion para un pago mas rapido con una cuenta Shop
                  </label>
                </div>
                <div className="relative">
                  <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-2 text-muted-foreground pointer-events-none">
              ...
              <Button
                ...
                size="lg"
              >
                {isLoading ? "Procesando..." : `Completar Pedido (€${total.toFixed(2)})`}
              </Button>
