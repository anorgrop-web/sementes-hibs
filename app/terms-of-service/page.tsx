          ...
          <div className="prose prose-sm max-w-none space-y-8 text-foreground">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                representative. Natural variation in colour, size, and shape is expected and does not constitute a
                defect.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-2">
                ...
                authorise the payment charge. Prices displayed in the store&apos;s currency (EUR, GBP, or USD). We may
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                See our{" "}
                <Link href="/shipping-policy" className="text-[#016630] hover:underline">
                  Shipping Policy
                </Link>
                .
              </p>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                See our{" "}
                <Link href="/refund-policy" className="text-[#016630] hover:underline">
                  Refund Policy
                </Link>{" "}
