          ...
          <div className="prose prose-sm max-w-none space-y-8 text-foreground">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground pl-2">
                ...
                <li>
                  <span className="font-medium text-foreground">Google Analytics:</span> Anonymised website usage data.
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                (name and address for fulfilment), Facebook/Meta (anonymised purchase data via Pixel), Google
