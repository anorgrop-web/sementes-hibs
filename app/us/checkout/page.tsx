...
function CheckoutForm() {
  ...
  const getPhonePrefix = (countryValue: string): string => {
    ...
    return phonePrefixMap[countryValue] || "+1"
  }
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <Label htmlFor="standard" className="cursor-pointer">
                            ...
                            <div className="text-xs text-muted-foreground mt-0.5">10-15 days</div>
                          </Label>
                        </div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <Label htmlFor="express" className="cursor-pointer">
                            ...
                            <div className="text-xs text-muted-foreground mt-0.5">5-7 days</div>
                          </Label>
                        </div>
...
All transactions are secure and encrypted. Your order is protected by our 30-day satisfaction guarantee.
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-2 text-xs text-primary justify-center">
                <Link href="/us/refund-policy" className="hover:underline">
                  Refund Policy
                </Link>
                <Link href="/us/shipping-policy" className="hover:underline">
                  Shipping
                </Link>
                <Link href="/us/privacy-policy" className="hover:underline">
                  Privacy Policy
                </Link>
                <Link href="/us/terms-of-service" className="hover:underline">
                  Terms of Service
                </Link>
                <Link href="/us/contact" className="hover:underline">
                  Contact
                </Link>
              </div>
            </div>
