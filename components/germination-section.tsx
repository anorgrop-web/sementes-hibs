...
const items = [
  ...
  },
  {
    ...
    description:
      "Not garden centre soil. A proprietary blend engineered specifically for hibiscus germination — perfect moisture retention, ideal drainage, precise acidity. Your seeds don't adapt to the soil. The soil adapts to them.",
  },
  {
    icon: FlaskConical,
    ...
    description:
      "The difference between 'it grew' and 'it's breathtaking.' Our fertilizer accelerates root development and triggers abundant flowering — turning healthy plants into show-stopping displays of colour.",
  },
  {
    icon: Shield,
