...
export function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      description: "Substrate, fertilizer, fungicide, seeds, and app — every element is chosen to work together. No guesswork, no extra trips to the garden centre, no YouTube rabbit holes.",
    },
    {
    ...
    {
      title: "Colours That Light Up Any Space",
      description: "Rare double-petal hibiscus in vivid reds, pinks, purples, and yellows. Whether it's a balcony, a patio, or a full garden — these flowers become the centrepiece.",
    },
  ]
