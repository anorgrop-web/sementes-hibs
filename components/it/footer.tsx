...
export function Footer() {
  const policyLinks = [
    { label: "Politica di Rimborso", href: "/it/refund-policy" },
    { label: "Spedizione", href: "/it/shipping-policy" },
    { label: "Informativa sulla Privacy", href: "/it/privacy-policy" },
    { label: "Termini e Condizioni", href: "/it/terms-of-service" },
    ...
    <footer className="bg-primary text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center space-y-1">
          <p className="text-sm text-white/80">© 2026 Versia Garden. Tutti i diritti riservati.</p>
          <p className="text-xs text-white/60">
            Gestito da: 57.203.094 MARIA CLARA RODRIGUES LEITE | CNPJ: 57.203.094/0001-13
          </p>
          <p className="text-xs text-white/60">
